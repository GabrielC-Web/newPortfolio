...
export class SkillsComponent {
  ...
  @Input() skills: any[] = [
    ...
    },
    {
      ...
      position: 3,
      description:
        'Tailwind es un framework CSS que nos proporciona clases de utilidad de un solo propósito que son opinables en su mayor parte, y que nos ayudan a diseñar nuestras páginas web desde dentro de nuestro marcado o archivos.',
    ...
    {
      title: 'Next.js',
      imgDark: NEXTJS_WHITE,
      imgLight: NEXTJS,
      position: 5,
      description:
        'Next.js es un framework de JavaScript de código abierto que permite crear sitios web y aplicaciones web modernas. Está basado en React y fue desarrollado por Vercel',
      zelda: 'https://nextjs.org/',
    },
    {
      title: 'Flutter',
      imgDark: FLUTTER,
